  ...
  "tracking-tight pb-3 bg-clip-text text-transparent",
  {
    variants: {
      variant: {
        ...
        pink:
          "bg-gradient-to-t from-accent to-accent/90 dark:from-stone-200 dark:to-neutral-200",
      ...
      size: {
        ...
        xll:
          "text-5xl sm:text-6xl lg:text-[5.4rem] lg:leading-[0.5rem]",
...
const GradientHeading = React.forwardRef(
  ({ asChild, variant, size, weight, className, children, ...props }, ref) => {
