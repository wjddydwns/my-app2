      ...
      <Menu setActive={setActive}>
        ...
        <MenuItem setActive={setActive} active={active} item="Projects">
          <div className="  text-sm grid grid-cols-2 gap-10 p-4">
            <ProductItem
              title="Netflix-clone"
              href="https://effulgent-babka-cf232a.netlify.app/"
              src="img/pj_img/netflix.webp"
              description="넷플릭스 클론 프로젝트 입니다. react redux"
            />
            <ProductItem
              title="N-Store Demo"
              href="https://n-store-demo.netlify.app/"
            ...
            <ProductItem
              ...
              src="https://assets.aceternity.com/demos/Screenshot+2024-02-21+at+11.47.07%E2%80%AFPM.webp"
